...
const MyReservationsPage: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* MODAL MANUAL - ENTENDA OS STATUS */}
      {showManual && (
          ...
          <div style={{ backgroundColor: "#fff", borderRadius: "16px", width: "90%", maxWidth: "600px", boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1)", overflow: "hidden", display: "flex", flexDirection: "column", maxHeight: "90vh" }} onClick={e => e.stopPropagation()}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "20px 30px", borderBottom: "1px solid #f1f5f9" }}>
              <h3 style={{ margin: 0, display: "flex", alignItems: "center", gap: "10px", color: "#1e293b" }}>
                <HelpCircle size={22} color="#2563eb" /> Manual do Usuário: Gestão de Reservas
              </h3>
            ...
            <div style={{ padding: "30px", overflowY: "auto", flexGrow: 1 }}>
              <div style={{ color: "#475569", lineHeight: "1.6" }}>
                <p style={{ marginBottom: "25px", fontSize: "1rem" }}>
                  Aprenda como gerenciar e acompanhar todas as suas locações de forma rápida e eficiente.
                </p>
                ...
                <div style={{ display: "flex", gap: "15px", marginBottom: "15px", padding: "15px", backgroundColor: "#f8fafc", borderRadius: "12px", border: "1px solid #f1f5f9" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "50%", backgroundColor: "#2563eb", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "0.75rem", flexShrink: 0 }}><Search size={14} /></div>
                  <div>
                    <strong style={{ display: "flex", alignItems: "center", gap: "5px" }}>Busca e Filtros:</strong>
                    <p style={{ margin: "5px 0 0 0" }}>Use a barra de pesquisa para encontrar pedidos rapidamente digitando o número do pedido (ID), a data da locação, ou até mesmo o nome do equipamento alugado. Você também pode ordenar a lista por data ou ID usando a caixa de seleção ao lado.</p>
                  </div>
                </div>

                <div style={{ display: "flex", gap: "15px", marginBottom: "15px", padding: "15px", backgroundColor: "#f8fafc", borderRadius: "12px", border: "1px solid #f1f5f9" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "50%", backgroundColor: "#2563eb", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "0.75rem", flexShrink: 0 }}><FileText size={14} /></div>
                  <div>
                    <strong style={{ display: "flex", alignItems: "center", gap: "5px" }}>Ver Detalhes do Pedido:</strong>
                    <p style={{ margin: "5px 0 0 0" }}>Clique no botão "Ver Detalhes do Pedido" ou no próprio card para abrir a página completa da reserva. Lá você poderá visualizar todas as informações da sua locação, avisar a loja de que o equipamento já pode ser retirado e solicitar a remarcação de datas, caso precise.</p>
                  </div>
                </div>

                <div style={{ display: "flex", gap: "15px", marginBottom: "15px", padding: "15px", backgroundColor: "#f8fafc", borderRadius: "12px", border: "1px solid #f1f5f9" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "50%", backgroundColor: "#2563eb", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "0.75rem", flexShrink: 0 }}><XOctagon size={14} /></div>
                  <div>
                    <strong style={{ display: "flex", alignItems: "center", gap: "5px" }}>Cancelamentos:</strong>
                    <p style={{ margin: "5px 0 0 0" }}>Se precisar cancelar uma reserva, o botão "Cancelar Reserva" estará disponível para pedidos que ainda não saíram para entrega. Fique atento às taxas de cancelamento tardio, caso se apliquem.</p>
                  </div>
                </div>

                <div style={{ display: "flex", gap: "15px", marginBottom: "15px", padding: "15px", backgroundColor: "#f8fafc", borderRadius: "12px", border: "1px solid #f1f5f9" }}>
                  <div style={{ width: "24px", height: "24px", borderRadius: "50%", backgroundColor: "#2563eb", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: "bold", fontSize: "0.75rem", flexShrink: 0 }}><CheckCircle size={14} /></div>
                  <div>
                    <strong style={{ display: "flex", alignItems: "center", gap: "5px" }}>Acompanhamento de Status:</strong>
                    <p style={{ margin: "5px 0 0 0" }}>Cada card de pedido exibe uma etiqueta (ex: "PENDENTE", "EM ANDAMENTO") para você saber exatamente em que etapa sua locação está, desde o pagamento do sinal até a devolução final.</p>
                  </div>
                </div>
              </div>
            </div>
